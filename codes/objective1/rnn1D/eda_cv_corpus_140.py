...
filenames_list = [["validated.tsv"], ["invalidated.tsv"], ["other.tsv"]]
files_tsv_folder_path = "../cv_corpus_14.0/en/"
...
def load_tsv_files(print_choice=0): # print_choice=1 if you want to print the informations of the function
...
def get_wrong_values(filename, print_choice=0):
    ...
    for i in range(len(df)):
        if not str(df['age'].iloc[i]) in ['thirties', 'twenties', 'fifties', 'fourties', 'teens', 'sixties', 'seventies', 'nineties']:
...
def read_mp3file(filepath, print_choice=0): # print_choice=1 if you want to print the informations of the function
